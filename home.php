    ...
    <div class="row py-4">
        ...
        <div class="row py-4">
            <div class="col-md-4">
                ...
                ?>
                <p class="text-white">Per aspera ad astra, <b><?php echo $_SESSION['alias'] ?></b>.</p>
                ...
                <div class="py-1">
                <i class="fas fa-skull-crossbones fa-lg text-white"></i>
                <a href="php/_logout.php"> Cerrar sesión</a><br>
                </div>

            </div>
            <div class="col-md-4">
                <form  class="form-group" action="" method="post">
                    <textarea class="form-control" name="epitafio" id="epitafio-area" cols="30" rows="10" placeholder="Escribe tus últimas palabras."></textarea>
